...
pub fn render() -> Markup {
    layout(
        ...
        html! {
            ...
            div.about-questions.full-width {                
                p { 
            ...
            h2 { "The Schedule" }
            p {
                "Monthly competitions run from October to April. Competitions a held a participating churches
                across the country. Online competitions are also available. 
                A regional finals prep quiz is held in May. 
